...
const itineraryData: Record<string, {
  ...
  "swedish-lapland-arctic-winter": {
    ...
    overview: "Swedish Lapland presents a distinctly Scandinavian proposition — a place where cutting-edge architectural design coexists without contradiction with untamed Arctic wilderness. Here you might sleep suspended in a mirrored glass cube invisible in the forest canopy, or within a room carved entirely from glacial ice. This is a journey that honours Sweden's particular genius: the belief that functional elegance and deep wilderness immersion are not competing values but complementary ones.",
    guestProfile: "Design-conscious couples and small groups of 2–6 who hold architectural and cultural experience in equal regard to wilderness adventure. Those who approach travel the way they approach interiors: with discernment, patience, and genuine interest in craft. Travellers seeking substantial physical comfort alongside honest exposure to the Arctic — the warmth of exceptional design as contrast to extraordinary cold.",
    whenToVisit: "November through March. December through February offer optimal conditions for dog sledding, snowmobile safaris, and winter wilderness. January and February provide the darkest nights for aurora viewing. Late March brings longer days and a different, crystalline quality of light as winter begins its retreat.",
    journeyFlow: ["Stockholm", "Kiruna", "Jukkasjärvi", "Treehotel", "Abisko"],
    activities: [
      "Nights in architectural statements — mirrored glass treehouses, artist-designed ice suites",
      "Dog sledding expeditions through pristine boreal forest with expert mushers",
      "Snowmobile safaris to frozen mountain lakes and remote wilderness",
      "Sámi cultural immersion: herding practices, joik, and traditional open-fire meals",
      "Cross-country skiing and snowshoe treks through Abisko National Park",
      "Aurora viewing from the Abisko Sky Station above the cloud line"
    ],
    accommodation: "An intentional sequence of architectural statements: the Treehotel's mirrored cube and bird's nest suspended in pine forest; ICEHOTEL's art suites sculpted fresh each winter by international artists; and small-scale mountain lodges of raw timber and glass. Each property was chosen for what it demonstrates about the Nordic capacity to make beauty functional — and functionality beautiful.",
    designRationale: "Each accommodation in this itinerary is as much a destination as the landscape surrounding it. The sequencing builds an arc from Stockholm's urban design sensibility through increasingly remote expressions of Nordic craft, arriving finally at wilderness lodges where architecture and environment become indistinguishable. Activities are structured to develop comfort and skill progressively — building towards the more physical and remote experiences as the journey deepens.",
    gridImages: [
      { src: "/images/treehotel.jpg", alt: "Mirrored cube treehouse in Swedish Lapland forest", span: "wide" },
      { src: "/images/husky-sled.jpg", alt: "Dog sledding through boreal forest", span: "normal" },
      { src: "/images/lapland-lodge.jpg", alt: "Nordic wilderness lodge", span: "normal" },
